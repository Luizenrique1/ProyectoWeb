...
<div class="alert alert-success" role="alert">
 Infromacion de cuenta actualizada
</div>
<div class="">
                            ...
                            <div class="form-group col-md-2">
                              ...
                              <?php echo $zip; ?>
                                ...
                                <div class="form-group col-md-6 text-left">
                                    <button type="button" class="btn btn-success">Modificar Perfil</button>
                                </div>
                                    <div class="form-group col-md-6 text-right">
                                    <button type="button" class="btn btn-danger">Elimanar Cuenta</button>
                                </div>
                            </div>
                          </form>
